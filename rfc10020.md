...
{{fig-gname-path-example-2}} provides a different example, where an IPv6 address literal and the default CoAP port number 5683 are used in the authority component, which yields a compact CoAP request. Also, the resource structure is different in this example.
